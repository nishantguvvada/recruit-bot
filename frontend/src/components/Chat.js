...
export const Chat = () => {
    ...
    const initialMessage = "Hello, I'm your AI assistant for recruitment. I analyze your requirements to fetch the most relevant candidates that fit your business.";
    ...
    return (
        <>
            <div className="mt-8 h-screen w-full flex justify-center">
                <div className="mt-8 w-full mx-4 md:w-[30%]">
                    ...
                    <div className="w-full h-[30%] p-4 border border-gray-200 bg-white">
                        <div className="grid grid-cols-3">
                    ...
                    <div className="w-full p-4 border border-gray-200 bg-gray-50 rounded-b-xl">
                        <div className="grid grid-cols-3">
                            <div className="col-span-2">
                                <textarea onChange={(e) => { setUserInput(userInput => e.target.value) }} id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="List all the candidates with experience in React."></textarea>
                            </div>
                            <button onClick={askHandler} className="col-span-1 relative h-full items-center justify-center p-0.5 ml-2 overflow-hidden text-sm font-bold text-white rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300">
                                Send
                            </button>
